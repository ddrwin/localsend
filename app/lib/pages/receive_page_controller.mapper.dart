...
class ReceivePageVmMapper extends ClassMapperBase<ReceivePageVm> {
  ...
  static Function _$onAccept(ReceivePageVm v) =>
      (v as dynamic).onAccept as Function;
  static dynamic _arg$onAccept(f) => f<void Function()>();
  static const Field<ReceivePageVm, Function> _f$onAccept =
      Field('onAccept', _$onAccept, arg: _arg$onAccept);
  static Function _$onDecline(ReceivePageVm v) =>
      (v as dynamic).onDecline as Function;
  static dynamic _arg$onDecline(f) => f<void Function()>();
  static const Field<ReceivePageVm, Function> _f$onDecline =
      Field('onDecline', _$onDecline, arg: _arg$onDecline);
  static Function _$onClose(ReceivePageVm v) =>
      (v as dynamic).onClose as Function;
  static dynamic _arg$onClose(f) => f<void Function()>();
  static const Field<ReceivePageVm, Function> _f$onClose =
      Field('onClose', _$onClose, arg: _arg$onClose);
